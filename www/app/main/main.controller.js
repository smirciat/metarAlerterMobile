  ...
  .controller('MainController',function($http, $scope, $timeout,$interval,$cordovaOneSignal) {
    ...
    self.avwx=function(index){
      self.$http.get('https://avwx.rest/api/metar/' + self.airports[index].icao).then(function(response){
        ...
        else if (len>-1&&(response.data['Cloud-List'][0][0]==='BKN'||response.data['Cloud-List'][0][0]==='OVC')) self.airports[index].ceiling=response.data['Cloud-List'][0][1]+'00';
        else if (len>=2&&(response.data['Cloud-List'][1][0]==='BKN'||response.data['Cloud-List'][1][0]==='OVC')) self.airports[index].ceiling=response.data['Cloud-List'][1][1]+'00';
        else if (len>=3&&(response.data['Cloud-List'][2][0]==='BKN'||response.data['Cloud-List'][2][0]==='OVC')) self.airports[index].ceiling=response.data['Cloud-List'][2][1]+'00';
        else if (len>=4&&(response.data['Cloud-List'][3][0]==='BKN'||response.data['Cloud-List'][3][0]==='OVC')) self.airports[index].ceiling=response.data['Cloud-List'][3][1]+'00';
